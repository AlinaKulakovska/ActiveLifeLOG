...
import { CgAlbum, CgCalendar, CgCalendarDates, CgClose } from 'react-icons/cg';
import './App.scss';
      ...
      <section className='hero'>
        <div className='nav py-2 px-10 flex justify-between w-full  items-center'>
          ...
          <div className='flex items-center relative'>
            <div >
              {logined ? <CiHome className='text-2xl md:text-3xl lg:text-5xl hover:cursor-pointer' onClick={() => setHideMenu(!hidemenu)} /> : <CiLogin className='text-2xl md:text-4xl lg:text-6xl hover:cursor-pointer' onClick={() => setHide(!hide)} />}
            </div>

            <div className={hidemenu ? "hide" : ""}>
              <div className='absolute right-0 top-[100%] p-2 text-center items-center bg-[#ffffff] text-[#181818]'>
                <a href='' className='flex items-center '><CgAlbum />Plan</a>
                <a href='' className='flex items-center'><CgCalendarDates /> Tracker</a>
              </div>
            </div>
